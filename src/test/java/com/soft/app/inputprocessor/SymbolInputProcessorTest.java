...
public class SymbolInputProcessorTest {
    ...
    public void validateResult1() {
        assertDoesNotThrow(() -> new SymbolInputProcessor().validateResult(text_dont_throw_exception));
    }

    @Test
    public void validateResult2() {
        assertThrows(LimitedInputException.class, () -> new SymbolInputProcessor().validateResult(text_throw_exception));
    }
}